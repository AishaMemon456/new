<html>
    ...
    <body class="bg-white-50 flex flex-col text-blue-900 h-svh">
        <div class="bg-red-200 p-8">
         <h1 class=" text-blue-500 text-6xl">Header</h1>
        </div>
            ...
            <div class='bg-white-500 text-black-500 p-4 rounded-md shadow-2xl slideDown' style='width:30%;'>
                <form id='ecommerceForm' onsubmit='event.preventDefault();' style='display:flex ;flex-direction:column; gap:4px;'>
                    ...
                    <div>
                        ...
                        <button type='button' onclick="submitCheckout()" id='submitBtn' class='bg-blue-200 text-white-200 p-2 border-0 hover:bg-blue-700 active:bg-blue-700 rounded-md' >Checkout</button>
                </form>
                <div>
                ...
                <div id='main' class="p-4 grid grow border-box bg-white-50 grid-cols-2 gap-4">
    ...
    function renderCarts() {
        ...
        checkoutForm.cart_details.forEach((x) => {
            var priceBox = x.discounted_price < x.price ? `<div class='actual-price'>
                 ...
                 cartHtml += `<div class="box" style="background-color:pink;">
            ...
            cartHtml+= `<div style="padding:10px; font-weight:bold color:purple;">
    ...
    function renderProducts() {
       ...
       var priceBox = x.discounted_price < x.price ? `<div class = 'actual-price'>
        ...
        `+x.discounted_price+`
        </div>` : `<div class='text-light purple-500'>
            `+x.price+`
            </div>` ;
        productHtml +=  `<div class='bg-white-500 text-black-500 p-4 rounded-md shadow-2xl slideDown'>'
           <h1 class='font-bold'>`+ x.name + `</h1>
            ...
            <div class=''>
                ...
                <button class='bg-blue-500 text-white-200 font-medium rounded-lg w-32 py-1 ' onclick='addToCart(`+x.id+`)'>Add to Cart</button>
